      ...
      >
        ...
        {state === "Sign Up" && (
          <div className="w-full">
            <p>Full Name</p>
            <input
              className="border border-zinc-300 rounded w-full p-2 mt-1 text-zinc-700"
              type="text"
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full cursor-pointer text-base bg-blue-600 text-white rounded-md py-2 ${loading ? "opacity-50 cursor-not-allowed" : ""
            }`}
        >
          {loading
            ? "Processing..."
