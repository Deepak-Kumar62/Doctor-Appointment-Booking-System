...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-blue-500 rounded-lg px-6 lg:px-20'>
        {/* ------ Left Side ------- */}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row gap-3 text-white text-sm font-light  '>
                ...
                <p>Simply browse through our extensive list of trusted doctor <br className='hidden sm:block'/> scheduled your appointment hassle-free</p>
            </div>
