...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-600 md:mx-10'>
            ...
            <button onClick={() => { navigate("/doctors"), scrollTo(0, 0) }} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 cursor-pointer hover:scale-105 transition-all duration-300'>more</button>
        </div>
    )
}
