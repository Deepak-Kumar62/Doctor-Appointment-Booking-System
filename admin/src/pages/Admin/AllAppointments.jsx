  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        <ul className='hidden sticky top-0 bg-gray-200 z-10 sm:grid grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 border-b'>
          <li>#</li>
          <li>Patient</li>
          <li>Age</li>
          <li>Date & Time</li>
        ...
        <ul>
          {appointments.map((item, index) => (
            <li
              className='flex flex-col sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] py-4 px-6 border-b border-gray-200 hover:bg-gray-100 transition'
              key={index}
            >
